 ...
 */
final class Version20221129135950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE indication (id INT AUTO_INCREMENT NOT NULL, traitement_id INT DEFAULT NULL, medicament_id INT DEFAULT NULL, posologie VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_D15065D7DDA344B6 (traitement_id), INDEX IDX_D15065D7AB0D61F7 (medicament_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
